...
{
    [ExportCodeRefactoringProvider(Sample.RefactoringId, LanguageNames.CSharp)]
    internal class Sample : ICodeRefactoringProvider
    {
        public const string RefactoringId = "RoslynSpike";
